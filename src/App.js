        ...
        <Row>
          <Col xs={12}>
            ...
            <ul>
              ...
              <li><p className="App__desc"><strong>Click or tap on a county</strong> to learn more about its news and information ecosystem and demographics, and to see a full list of the news and information sources we’ve identified so far along with media type, sector, ownership, language, and reach (if we know it). NOTE: News sources are placed on the map according to their physical office address, which means some might not appear in counties they also serve.</p></li>
            </ul>
